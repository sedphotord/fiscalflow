              ...
              <Card>
                  ...
                  <CardContent className="space-y-4">
                      {fields.map((field, index) => (
                       ...
                       {createUserForm.formState.errors.teamMembers && !createUserForm.formState.errors.teamMembers.root && (
                          <p className="text-sm font-medium text-destructive">Hay errores en la información de los miembros del equipo.</p>
                      )}
                  </CardContent>
              </Card>
